...
#khoi tao cac node
    def __init__(self):
        ...
        self.gesture_subcriber = rospy.Subscriber(rospy.get_param("hand_sign_recognition/publish_gesture_topic"), 
                                                String, self.callback) #topic duoc dinh nghia trong hand_sign.launch
        # Publisher for publishing velocities 
        self.vel_publisher = rospy.Publisher("/robot_diff_drive_controller/cmd_vel", Twist, queue_size=10) #publish Twist 
        # Velocity message
        self.vel_msg = Twist()
        # Velocity increments
        self.linear_vel = 0.01 #[m/s] #chuyen dong tuyen tinh theo Ox
        self.angular_vel = 0.1 #[rad/s] #xoay treo truc Oz
    ...
    def callback(self, gesture):
        ...
        self.vel_publisher.publish(self.vel_msg) #vel_msg duoc publish boi vel_publisher
